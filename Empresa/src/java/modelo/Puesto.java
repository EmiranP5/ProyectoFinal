...
public class Puesto {
    ...
    public int agregar() {
        ...
        try {
            ...
            cn = new conexion();
            String query = "INSERT INTO puesto (puesto, estado) VALUES (?, 1);"; // Estado activo por defecto
            cn.abrir_conexion();
    ...
    public int modificar() {
        ...
        try {
            PreparedStatement parametro;
            cn = new conexion();
            String query = "UPDATE puesto SET puesto = ? WHERE id_Puesto = ?;";
            cn.abrir_conexion();
            parametro = cn.conexionBD.prepareStatement(query);
            parametro.setString(1, this.getPuesto());
    ...
    public int eliminar() {
        ...
        try {
            PreparedStatement parametro;
            cn = new conexion();
            String query = "UPDATE puesto SET estado = 0 WHERE id_Puesto = ?;"; // Cambiar el estado a inactivo
            cn.abrir_conexion();
            parametro = cn.conexionBD.prepareStatement(query);
