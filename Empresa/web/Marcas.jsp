<%-- 
    Document   : Marcas
    Created on : 29/09/2024, 1:29:11 p. m.
...
<html lang="en">
    ...
    <body>
        ...
        <button type="button" class="btn btn-info" data-bs-toggle="modal" data-bs-target="#modal_marca" onclick="limpiar()">Nueva Marca</button>
      ...
      <div class="modal-header">
        <h4 class="modal-title">Nuevas Marcas</h4>
        <button type="button" class="btn-close" data-bs-dismiss="modal"></button>
      </div>

      <div class="modal-body">
        <form action="sr_gu" method="post" class="form-group" >
                <label for="lbl_id"><b>ID Marca:</b> </label>
                <input type="text" name="txt_id" id="txt_id" class="form-control" value="0" readonly>
                <label for="lbl_marca"><b>Marca:</b> </label>
                <input type="text" name="txt_marca" id="txt_marca" class="form-control" placeholder="Ejemplo: Marca X" required>
                <br>
