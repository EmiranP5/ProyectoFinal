                        ...
                        <div class="row g-6">
                            <div class="col-md-6">
                                ...
                                <%
                                    ...
                                    HashMap<String,String> desplegar= marca.drop_marca();
                                ...
                                %>
                                 ...
                                 <div class="col-md-6">
                                     <label for="txt_f_ingreso"><b>Fecha y hora de ingreso:</b></label>
                                      <input type="datetime-local" name="txt_fecha_ingreso" id="txt_fecha_ingreso" class="form-control">
                                 </div>
